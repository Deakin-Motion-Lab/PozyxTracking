...
class ReadyToLocalize(object):
    ...
    def setup(self):
        ...
        # Optional: Apply filter to smooth noise
        #filterStrength = 0    # Set value between 0 to 15
        #self.pozyx.setPositionFilter(PozyxConstants.FILTER_TYPE_MOVING_AVERAGE, filterStrength, self.remote_id)
        #self.pozyx.setPositionFilter(PozyxConstants.FILTER_TYPE_MOVING_MEDIAN, filterStrength, self.remote_id)
        #self.pozyx.setPositionFilter(PozyxConstants.FILTER_TYPE_FIR, filterStrength, self.remote_id)
...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x675a, 1, Coordinates(0, 0, 1150)),    #1150 (desk high) or 750 (desk low)
